...
def write_settings_json(settings: dict) -> None:
    ...
    SETTINGS_JSON.write_text(json.dumps({
        ...
        "showGraph": bool(d.get("show_graph", True)),
        "showBreaks": bool(d.get("show_breaks", True)),
        "showColumns": bool(d.get("show_columns", True)),
        "showTeams": bool(d.get("show_teams", True)),
        "scoring": {
